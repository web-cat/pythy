# RailsAdmin config file. Generated on September 26, 2012 21:10
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Pythy', 'Admin']
  ...
  #     configure :assignment_offerings, :has_many_association 
  ...
  # config.model 'AssignmentOffering' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your assignment_offering.rb model definition
  
  #   # Found associations:

  #     configure :assignment, :belongs_to_association 
  #     configure :course_offering, :belongs_to_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :assignment_id, :integer         # Hidden 
  #     configure :course_offering_id, :integer         # Hidden 
  ...
  # config.model 'CourseOffering' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your course_offering.rb model definition
  ...
  #     configure :staff, :has_many_association 
  ...
  # config.model 'CourseOfferingStaff' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your course_offering_staff.rb model definition
  ...
  # config.model 'CourseOfferingStudent' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your course_offering_student.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your term.rb model definition
  ...
  #     configure :starts_on, :date 
  #     configure :ends_on, :date 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #     configure :course_offering_students, :has_many_association 
  #     configure :enrolled_course_offerings, :has_many_association 
